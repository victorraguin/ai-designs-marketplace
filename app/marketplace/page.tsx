...
export default function MarketplacePage () {
  ...
  const { user } = useAuth() // Si non connecté, user sera null

  useEffect(() => {
    loadDesigns()
    // Pour éviter des appels inutiles si page, sortBy ou selectedCategory changent,
    // on ne dépend plus de user pour charger les designs (Marketplace est public).
      ...
      <div className='container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col space-y-8'>
          ...
          <Tabs defaultValue='designs' className='space-y-4'>
            <TabsList>
              <TabsTrigger value='designs'>Marketplace</TabsTrigger>
            ...
            {user && (
              <>
                <TabsContent value='orders'>
                  {/* Votre composant ou contenu pour My Orders */}
                  <p>Orders content (visible only when logged in)</p>
                </TabsContent>
                <TabsContent value='profile'>
                  {/* Votre composant ou contenu pour Profile */}
                  <p>Profile content (visible only when logged in)</p>
                </TabsContent>
              </>
            )}
          </Tabs>
