...
import { Heart, Eye, Paintbrush, ShoppingBag } from 'lucide-react'
...
export default function DashboardClient ({
  ...
  const [stats, setStats] = useState<Stats>(initialDatas)
  ...
  // Actualise les données dès le montage et à chaque changement de pagination / filtre / tri
  useEffect(() => {
    if (user) {
      loadData()
    }
  ...
  async function loadData () {
    ...
    try {
      // Charger les designs avec pagination et filtres
